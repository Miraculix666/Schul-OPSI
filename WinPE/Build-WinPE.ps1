<#
    ...
    CHANGE SUMMARY: v2.1 - Auto-elevation, expanded params, always-interactive menu
    BRANCH: main
...
$script:EnvFile = Join-Path $script:ScriptDir "environment.json"
$script:LogFile = $null
...
try {
    ...
    # 4. INTERAKTIVE Konfiguration (IMMER!)
